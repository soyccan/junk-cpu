...
//just define, no usage
//`define ALU_CTL_LOAD  4'd14
//`define ALU_CTL_STORE 4'd15
//`define ALU_CTL_BRANCH 處理?

`define ALU_OP_REG    2'd0  // R-type instruction
`define ALU_OP_IMM    2'd1  // I-type instruction , lw instruction(project_1 specifly)
//new def
...
// `define OPCODE_BASE_OP       7'b0110011
// `define OPCODE_BASE_OP_IMM   7'b0010011
